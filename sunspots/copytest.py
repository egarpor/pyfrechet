...
def custom_spheroid_GCV(X_train, y_train, param_grid, seed=5, n_splits=2):
    """
    ...
    sphere_points = canonical_lattice(50)
    ...
    for min_split_size, mtry, (a, c) in grid:
        ...
        for train_index, val_index in kf.split(X_train):
            ...
            forest = BaggedRegressor(estimator=base, n_estimators=40,
    ...
    final_forest = BaggedRegressor(estimator=final_tree, n_estimators=40,
                                   bootstrap_fraction=1, bootstrap_replace=True,
                                   seed=seed, n_jobs=1)
...
def task(cyc):
    ...
    can_lat = canonical_lattice(50)
    results['area_spheroid'] = sphere_area_pred_ball(M, spheroid_oob_quantile, spheroid_centers = spheroid_preds.data, sphere_points = can_lat, n_jobs=1)

    # Save results
    output_path = f'sunspots/aaaaa.npy'
